...
DAYS_LIMIT = 5
START_DATE = "2025-06-20 00:00:00"  # Set your desired start date here
OUTPUT_DIR = "../backtest_data_20250625-20"

# Define specific tickers to fetch or leave empty to fetch all
TARGET_TICKERS = ["BTCUSDT", "SOLUSDT", "ETHUSDT"]  # Example: ["BTCUSDT", "ETHUSDT"]
...
def main():
    tickers = TARGET_TICKERS if TARGET_TICKERS else get_spot_tickers("USDT")
